...
#loading data
Amm_all_TPM <-read.table("~/Rana_Transcriptome/input/Amm_all_TPM.txt",header = T)
str(Amm_all_TPM)
...
write.table(s, file="~/Rana_Transcriptome/output/tau/tau_amm.txt",row.names=TRUE, sep="\t", quote= FALSE)

#plot tau
tau_amm <- read.table("~/Rana_Transcriptome/output/tau/tau_amm.txt", header=T)
pdf("~/Rana_Transcriptome/output/tau/tau_amm_logtransf.pdf", width=8, height=8)
...
write.table(s, file="~/Rana_Transcriptome/output/tau/tau_amm_withoutlogtransf.txt",row.names=TRUE, sep="\t", quote= FALSE)

#make ggplot for non-log transformed tau distribution
tau_amm_nolog <- read.table("~/Rana_Transcriptome/output/tau/tau_amm_withoutlogtransf.txt", header=T)
pdf("~/Rana_Transcriptome/output/tau/tau_amm_withoutlogtransf.pdf", width=8, height=8)
...
write.table(s2, file="~/Rana_Transcriptome/output/tau/tau_amm_log_TSI0.9.txt",row.names=TRUE, sep="\t", quote= FALSE)
s3 <- subset(tau_amm,tau_amm[,2]<=0.2)
write.table(s3, file="~/Rana_Transcriptome/output/tau/tau_amm_log_TSI0.2.txt",row.names=TRUE, sep="\t", quote= FALSE)

##############
#load data from folder G46
##############

g46_tau <- read.table("~/Rana_Transcriptome/input/G46_tau/G46_sb_un_tau_match_fi.txt", header = TRUE)
str(g46_tau)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_g46.pdf", width=8, height=8)
...
#scatter plot
abs_g46_tau <- read.table("~/Rana_Transcriptome/input/G46_tau/G46_abssb_un_tau_match_fi.txt", header = TRUE)
str(abs_g46_tau)

pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_g46_sb.pdf", width=8, height=8)
p2 <- 
...
##########
##boxplot
gonad_tau <- read.table("~/Rana_Transcriptome/input/Gonad_tau/gonad_fc1_sb_unbias_tau.txt", header = TRUE)
str(gonad_tau)

pdf("~/Rana_Transcriptome/output/tau/tau_gonad_sb.pdf", width=8, height=8)
...
##############
g43_tau <- read.table("~/Rana_Transcriptome/input/G43_tau/Am43_log1_sb_sorted.txt", header = TRUE)
str(g43_tau)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_g43.pdf", width=8, height=8)
...
#scatter plot
####G43
absg43tau <- read.table("~/Rana_Transcriptome/input/G43_tau/Am43_log1_sb_sorted.txt", header = TRUE)
str(absg43tau)
####

pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_g43_sb_nocolors.pdf", width=8, height=8)
...
########
g43_tau_dnds <- read.table("~/Rana_Transcriptome/input/G43_tau/Am43_log1_sb_shareunbias_dnds_sorted.txt", header = TRUE)
str(g43_tau_dnds)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_g43_dnds_shareunbias.pdf", width=8, height=8)
...
###tau
pdf("~/Rana_Transcriptome/output/tau/tau_amm_g43_tau_shareunbias.pdf", width=8, height=8)
...
abs_gonad_tau <- read.table("~/Rana_Transcriptome/input/Gonad_tau/gonad_fc1_abssb_unbias_tau.txt", header = TRUE)
str(abs_gonad_tau)

pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_gonad_sb.pdf", width=8, height=8)
...
#####gonad tau and dnds
##########
gonad_tau_dnds <- read.table("~/Rana_Transcriptome/input/Gonad_tau/gonad_fc1_tau_dnds_sb_shareunbias_sorted_fi.txt", header = TRUE)
str(gonad_tau_dnds)

pdf("~/Rana_Transcriptome/output/tau/gonad_sb_dnds_shareunbias.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/gonad_sb_tau_shareunbias.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_dnds.pdf", width=8, height=8)
...
##############
brain_tau <- read.table("~/Rana_Transcriptome/input/Brain_tau/Ambrain_log1_sbun_tau_match_sorted_fi.txt", header = TRUE)
str(brain_tau)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_brain.pdf", width=8, height=8)
...
brain_tau_dnds <- read.table("~/Rana_Transcriptome/input/Brain_tau/Ambrain_log1_sb_tau_match_dnds_sorted_fi_shareunbias.txt", header = TRUE)
str(brain_tau_dnds)

pdf("~/Rana_Transcriptome/output/tau/brain_sbun_dnds_shareunbias.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/tau_amm_brain_shareunbias.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_brain_exp.pdf", width=8, height=8)
...
##############
liver_tau <- read.table("~/Rana_Transcriptome/input/Liver_tau/Amliver_log1_sbun_tau_match_sorted.txt", header = TRUE)
str(liver_tau)

abs <- abs(liver_tau$logFC.XYliver.XXliver)
pdf("~/Rana_Transcriptome/output/tau/tau_amm_liver.pdf", width=8, height=8)
...
####
liver_tau_dnds <- read.table("~/Rana_Transcriptome/input/Liver_tau/Amliver_log1_sb_shareunbias_tau_dnds_fi.txt", header = TRUE)
str(liver_tau_dnds)

pdf("~/Rana_Transcriptome/output/tau/liver_sbun_dnds.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/liver_sbun_tau_sharebias.pdf", width=8, height=8)
...
---
pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_liver_dnds.pdf", width=8, height=8)
...
pdf("~/Rana_Transcriptome/output/tau/scatter_abs_tau_exp_liver_nocolors.pdf", width=8, height=8)
...
###
alltissues_tau <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/am_tau_8tissues_fi.txt", header = TRUE)
str(alltissues_tau)

pdf("~/Rana_Transcriptome/output/figures/alltissue_tau.pdf", width=8, height=8)
...
fourtissues_tau_top30 <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_g2346gonadliver.txt", header = TRUE)
str(fourtissues_tau_top30)

pdf("~/Rana_Transcriptome/output/figures/4tissue_tau_top30.pdf", width=8, height=8)
...
alltissues_tau_top70 <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_alltissues_top70.txt", header = TRUE)
str(alltissues_tau_top70)

pdf("~/Rana_Transcriptome/output/figures/alltissue_tau_top70.pdf", width=8, height=8)
...
g23_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg23.txt", header = TRUE)
str(g23_all)
...
write.table(g23_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg23_top10.txt", sep="\t", col.names=T)

g23_top90 <- data.frame(g23_all_sort[1:21490,])
write.table(g23_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg23_top90.txt", sep="\t", col.names=T)

g23_top30 <- data.frame(g23_all_sort[1:7163,])
write.table(g23_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg23_top30.txt", sep="\t", col.names=T)

g23_top70 <- data.frame(g23_all_sort[1:16714,])
write.table(g23_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg23_top70.txt", sep="\t", col.names=T)

g23_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amg23_topall.txt", header = TRUE)
str(g23_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_amg23_topall", width=8, height=8)
...
g27_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg27.txt", header = TRUE)
str(g27_all)
...
write.table(g27_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg27_top10.txt", sep="\t", col.names=T)

g27_top90 <- data.frame(g27_all_sort[1:21490,])
write.table(g27_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg27_top90.txt", sep="\t", col.names=T)

g27_top30 <- data.frame(g27_all_sort[1:7163,])
write.table(g27_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg27_top30.txt", sep="\t", col.names=T)

g27_top70 <- data.frame(g27_all_sort[1:17059,])
write.table(g27_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg27_top70.txt", sep="\t", col.names=T)

g27_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amg27_topall.txt", header = TRUE)
str(g27_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_amg27_topall", width=8, height=8)
...
g31_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg31.txt", header = TRUE)
str(g31_all)
...
write.table(g31_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg31_top10.txt", sep="\t", col.names=T)

g31_top90 <- data.frame(g31_all_sort[1:21490,])
write.table(g31_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg31_top90.txt", sep="\t", col.names=T)

g31_top30 <- data.frame(g31_all_sort[1:7163,])
write.table(g31_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg31_top30.txt", sep="\t", col.names=T)

g31_top70 <- data.frame(g31_all_sort[1:16629,])
write.table(g31_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg31_top70.txt", sep="\t", col.names=T)

g31_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amg31_topall.txt", header = TRUE)
str(g31_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_g31_topall", width=8, height=8)
...
g43_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg43.txt", header = TRUE)
str(g43_all)
...
write.table(g43_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg43_top10.txt", sep="\t", col.names=T)

g43_top90 <- data.frame(g43_all_sort[1:21490,])
write.table(g43_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg43_top90.txt", sep="\t", col.names=T)

g43_top30 <- data.frame(g43_all_sort[1:7163,])
write.table(g43_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg43_top30.txt", sep="\t", col.names=T)

g43_top70 <- data.frame(g43_all_sort[1:17091,])
write.table(g43_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg43_top70.txt", sep="\t", col.names=T)

g43_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amg43_topall.txt", header = TRUE)
str(g43_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_g43_topall", width=8, height=8)
...
brain_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Ambrain.txt", header = TRUE)
str(brain_all)
...
write.table(brain_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/ambrain_top10.txt", sep="\t", col.names=T)

brain_top90 <- data.frame(brain_all_sort[1:23899,])
write.table(brain_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/ambrain_top90.txt", sep="\t", col.names=T)

brain_top30 <- data.frame(brain_all_sort[1:7163,])
write.table(brain_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/ambrain_top30.txt", sep="\t", col.names=T)

brain_top70 <- data.frame(brain_all_sort[1:18588,])
write.table(brain_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/ambrain_top70.txt", sep="\t", col.names=T)

brain_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_ambrain_topall.txt", header = TRUE)
str(brain_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_brain_topall", width=8, height=8)
...
g46_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg46.txt", header = TRUE)
str(g46_all)
...
write.table(g46_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg46_top10.txt", sep="\t", col.names=T)

g46_top90 <- data.frame(g46_all_sort[1:21490,])
write.table(g46_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg46_top90.txt", sep="\t", col.names=T)

g46_top30 <- data.frame(g46_all_sort[1:7482,])
write.table(g46_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg46_top30.txt", sep="\t", col.names=T)

g46_top70 <- data.frame(g46_all_sort[1:17458,])
write.table(g46_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amg46_top70.txt", sep="\t", col.names=T)


g46_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amg46_topall.txt", header = TRUE)
str(g46_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_g46_topall", width=8, height=8)
...
gonad_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amgonad.txt", header = TRUE)
str(gonad_all)
...
write.table(gonad_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amgonad_top10.txt", sep="\t", col.names=T)

gonad_top90 <- data.frame(gonad_all_sort[1:21490,])
write.table(gonad_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amgonad_top90.txt", sep="\t", col.names=T)

gonad_top30 <- data.frame(gonad_all_sort[1:6768,])
write.table(gonad_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amgonad_top30.txt", sep="\t", col.names=T)

gonad_top70 <- data.frame(gonad_all_sort[1:15792,])
write.table(gonad_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amgonad_top70.txt", sep="\t", col.names=T)

gonad_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amgonad_topall.txt", header = TRUE)
str(gonad_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_gonad_topall", width=8, height=8)
...
liver_all<- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amliver.txt", header = TRUE)
str(liver_all)
...
write.table(liver_top10, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amliver_top10.txt", sep="\t", col.names=T)

liver_top90 <- data.frame(liver_all_sort[1:21490,])
write.table(liver_top90, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amliver_top90.txt", sep="\t", col.names=T)

liver_top30 <- data.frame(liver_all_sort[1:5677,])
write.table(liver_top30, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amliver_top30.txt", sep="\t", col.names=T)
liver_top70 <- data.frame(liver_all_sort[1:13247,])
write.table(liver_top70, "~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/amliver_top70.txt", sep="\t", col.names=T)

liver_tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amliver_topall.txt", header = TRUE)
str(liver_tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_liver_topall", width=8, height=8)
...
tau_topall <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/tau_amall_topall_fifi.txt", header = TRUE)
str(tau_topall)

pdf("~/Rana_Transcriptome/output/figures/tau_alltissues_topall.pdf", width=8, height=8)
...
tau_unbias_amg23 <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg23_tau.txt", header = TRUE)
...
tau_unbias_amg27 <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg27_tau.txt", header = TRUE)
...
0.2233488 
###
tau_unbias_amg31 <- read.table("~/Rana_Transcriptome/input/sexsp_tau/cpm_tau/LogCPM_0.05_Amg31_tau.txt", header = TRUE)
...
pdf(file="~/Rana_Transcriptome/output/figures/correlation_5tissuesv2.pdf")
...
dnds_gonadg46 <- read.table("~/Rana_Transcriptome/input/G46_tau/overlap_gonadg46_taudnds_fi.txt", header = TRUE)
str(dnds_gonadg46)

pdf("~/Rana_Transcriptome/output/tau/dnds_amm_g46gonad_shared_sexbiasdirection_3category.pdf", width=8, height=8)
ggplot(dnds_gonadg46, aes(x=direction, y=dNdS, fill=direction)) + scale_fill_manual(values = c("firebrick2","dodgerblue2","grey40"), name="Sex bias direction",labels=c("Same","Change")) +
  geom_boxplot(notch=TRUE,outlier.shape=NA,width=0.7,alpha=0.9) +
  ylim(0,0.3) +
  scale_x_discrete(labels=c("female","male","yes"),name="Sex bias direction") + 
  theme(axis.title.x = element_text(size=16,colour = "black"),axis.title.y = element_text(size=16,colour = "black")) +
  theme(axis.text.x = element_text(colour="black",size=11),axis.text.y = element_text(colour="black",size=11))
dev.off()

wilcox.test(dnds_gonadg46$dNdS[dnds_gonadg46$direction=='female'],dnds_gonadg46$dNdS[dnds_gonadg46$direction=='male'],exact = FALSE) 
#W = 25469, p-value = 0.03583
wilcox.test(dnds_gonadg46$dNdS[dnds_gonadg46$direction=='female'],dnds_gonadg46$dNdS[dnds_gonadg46$direction=='yes'],exact = FALSE) 
#W = 18487, p-value = 0.09467
wilcox.test(dnds_gonadg46$dNdS[dnds_gonadg46$direction=='male'],dnds_gonadg46$dNdS[dnds_gonadg46$direction=='yes'],exact = FALSE) 
#W = 1291.5, p-value = 0.9947

tau_gonadg46 <- read.table("~/Rana_Transcriptome/input/G46_tau/overlgonadg46_list_sort_tau_fi.txt", header = TRUE)
str(tau_gonadg46)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_g46gonad_shared_sexbiasdirection_3cateory.pdf", width=8, height=8)
ggplot(tau_gonadg46, aes(x=direction, y=tau, fill=direction)) + scale_fill_manual(values =c("firebrick2","dodgerblue2","grey40"), name="Sex bias direction",labels=c("Same","Change")) +
  geom_boxplot(notch=TRUE,outlier.shape=NA,width=0.7,alpha=0.9) +
  ylim(0.1,1) +
  #scale_x_discrete(labels=c("female","male","yes"),name="Sex bias direction") + 
  theme(axis.title.x = element_text(size=16,colour = "black"),axis.title.y = element_text(size=16,colour = "black")) +
...
wilcox.test(tau_gonadg46$tau[tau_gonadg46$direction=='female'],tau_gonadg46$tau[tau_gonadg46$direction=='male'],exact = FALSE) 
#W = 351550, p-value < 2.2e-16
wilcox.test(tau_gonadg46$tau[tau_gonadg46$direction=='female'],tau_gonadg46$tau[tau_gonadg46$direction=='yes'],exact = FALSE) 
#W = 201680, p-value = 0.05813
wilcox.test(tau_gonadg46$tau[tau_gonadg46$direction=='male'],tau_gonadg46$tau[tau_gonadg46$direction=='yes'],exact = FALSE) 
#W = 13795, p-value = 3.105e-05

##investigate tau and dnds in sex-biased genes which remains the direciton of sex bias or had turnover: Gonad vs liver

tau_gonadliver <- read.table("~/Rana_Transcriptome/input/Gonad_tau/gonadliver_overlap_tau_fi.txt", header = TRUE)
str(tau_gonadliver)

pdf("~/Rana_Transcriptome/output/tau/tau_amm_livergonad_shared_sexbiasdirection_3category.pdf", width=8, height=8)
ggplot(tau_gonadliver, aes(x=direction, y=tau, fill=direction)) + scale_fill_manual(values = c("firebrick2","dodgerblue2","grey40"), name="Sex bias direction",labels=c("female","male","Change")) +
  geom_boxplot(notch=TRUE,outlier.shape=NA,width=0.7,alpha=0.9) +
  ylim(0.1,1) +
  scale_x_discrete(labels=c("female","male","yes"),name="Sex bias direction") +  
  theme(axis.title.x = element_text(size=16,colour = "black"),axis.title.y = element_text(size=16,colour = "black")) +
...
wilcox.test(tau_gonadliver$tau[tau_gonadliver$direction=='female'],tau_gonadliver$tau[tau_gonadliver$direction=='male'],exact = FALSE) 
#W = 377, p-value = 0.126
wilcox.test(tau_gonadliver$tau[tau_gonadliver$direction=='female'],tau_gonadliver$tau[tau_gonadliver$direction=='yes'],exact = FALSE) 
#W = 544, p-value = 0.9392
wilcox.test(tau_gonadliver$tau[tau_gonadliver$direction=='male'],tau_gonadliver$tau[tau_gonadliver$direction=='yes'],exact = FALSE) 
#W = 375, p-value = 0.06617

dnds_gonadliver <- read.table("~/Rana_Transcriptome/input/Gonad_tau/gonadliver_overlap_dnds_sexbdire_fi.txt", header = TRUE)
str(dnds_gonadliver)

pdf("~/Rana_Transcriptome/output/tau/dNdS_amm_livergonad_shared_sexbiasdirection_3category.pdf", width=8, height=8)
ggplot(dnds_gonadliver, aes(x=direction, y=dNdS, fill=direction)) + scale_fill_manual(values = c("firebrick2","dodgerblue2","grey40"), name="Sex bias direction",labels=c("female","male","Change")) +
  geom_boxplot(notch=TRUE,outlier.shape=NA,width=0.7,alpha=0.9) +
  ylim(0,0.25) +
  scale_x_discrete(labels=c("female","male","yes"),name="Sex bias direction") + 
  theme(axis.title.x = element_text(size=16,colour = "black"),axis.title.y = element_text(size=16,colour = "black")) +
...
wilcox.test(dnds_gonadliver$dNdS[dnds_gonadliver$direction=='female'],dnds_gonadliver$dNdS[dnds_gonadliver$direction=='male'],exact = FALSE) 
#W = 20.5, p-value = 0.266
wilcox.test(dnds_gonadliver$dNdS[dnds_gonadliver$direction=='female'],dnds_gonadliver$dNdS[dnds_gonadliver$direction=='yes'],exact = FALSE) 
#W = 52, p-value = 1
wilcox.test(dnds_gonadliver$dNdS[dnds_gonadliver$direction=='male'],dnds_gonadliver$dNdS[dnds_gonadliver$direction=='yes'],exact = FALSE) 
#W = 82, p-value = 0.4038
