...
#loading datasets
logFC_23 <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amg23.txt", header = T)
str(logFC_23)
logFC_23$stage = "G23"

logFC_27 <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amg27.txt", header = T)
str(logFC_27)
logFC_27$stage = "G27"

logFC_31 <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amg31.txt", header = T)
str(logFC_31)
logFC_31$stage = "G31"

logFC_43 <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amg43.txt", header = T)
str(logFC_43)
logFC_43$stage = "G43"

logFC_46nosr <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amg46nosr.txt", header = T)
str(logFC_46nosr)
logFC_46nosr$stage = "G46"

logFC_gonad <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amgonad.txt", header = T)
str(logFC_gonad)
logFC_gonad$stage = "gonad"

logFC_liver <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Amliver.txt", header = T)
str(logFC_liver)
logFC_liver$stage = "liver"

logFC_brain <-read.table("~/Rana_Transcriptome/input/CPM/LogCPM_0.05_Ambrain.txt", header = T)
str(logFC_brain)
logFC_brain$stage = "brain"

g23_sub <- data.frame(logFC.XY23.XX23,g23_sub$stage)
write.table(g23_sub, "~/Rana_Transcriptome/input/CPM/g23_sub.txt", sep="\t", col.names=F)

g27_sub <- data.frame(logFC.XY27.XX27, g27_sub$stage)
write.table(g27_sub, "~/Rana_Transcriptome/input/CPM/g27_sub.txt", sep="\t", col.names=F)

g31_sub <- data.frame(logFC.XY31.XX31,g31_sub$stage)
write.table(g31_sub, "~/Rana_Transcriptome/input/CPM/g31_sub.txt", sep="\t", col.names=F)

g43_sub <- data.frame(logFC.XY43.XX43,g43_sub$stage)
write.table(g43_sub, "~/Rana_Transcriptome/input/CPM/g43_sub.txt", sep="\t", col.names=F)

g46_sub <- data.frame(logFC.XY46.XX46,g46_sub$stage)
write.table(g46_sub, "~/Rana_Transcriptome/input/CPM/g46_sub.txt", sep="\t", col.names=F)

gonad_sub <- data.frame(logFC.XYtestis.XXovary,logFC_gonad$stage)
write.table(gonad_sub, "~/Rana_Transcriptome/input/CPM/gonad_sub.txt", sep="\t", col.names=F)

brain_sub <- data.frame(logFC.XYbrain.XXrain,logFC_brain$stage)
write.table(brain_sub, "~/Rana_Transcriptome/input/CPM/brain_sub.txt", sep="\t", col.names=F)

liver_sub <- data.frame(logFC.XYliver.XXliver,logFC_liver$stage)
write.table(liver_sub, "~/Rana_Transcriptome/input/CPM/liver_sub.txt", sep="\t", col.names=F)

logFC_all <-read.table("~/Rana_Transcriptome/input/CPM/all_sub_logfc.txt", header = T)
str(logFC_all)

new_stage <- factor(logFC_all$stage, levels=c("G23", "G27","G31","G43", "G46", "gonad","brain", "liver"))

pdf(file="~/Rana_Transcriptome/output/figures/violin_expressionratio.pdf")
...
### dataset from G46
datapath <- '~/Rana_Transcriptome/output/Amg46nosr/'
kdata <- read.table("~/Rana_Transcriptome/output/Amg46nosr/rpkm_list_count_sorted.txt",header = T)
str(kdata)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/g46nosr_fbias.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/g46nosr_mbias.txt", sep="\t", col.names=T)
write.table(kdata3, "~/Rana_Transcriptome/input/CPM/g46nosr_unbias.txt", sep="\t", col.names=T)

g46_fbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g46_fbias_short.txt", header=TRUE)
g46_fbias_all$bias = "female"
g46_mbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g46_mbias_short.txt", header=TRUE)
g46_mbias_all$bias = "male"
g46_unbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g46_unbias_short.txt", header=TRUE)
g46_unbias_all$bias = "unbias"

write.table(g46_fbias_all, "~/Rana_Transcriptome/input/CPM/g46_fbias_all2.txt", sep="\t", col.names=T)
write.table(g46_mbias_all, "~/Rana_Transcriptome/input/CPM/g46_mbias_all2.txt", sep="\t", col.names=F)
write.table(g46_unbias_all, "~/Rana_Transcriptome/input/CPM/g46_unbias_all2.txt", sep="\t", col.names=F)

g46_bias_all <- read.table("~/Rana_Transcriptome/input/CPM/g46_sbunbias_all_newfi.txt", header=TRUE)
str(g46_bias_all)

pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_log2rpkm_g46.pdf")

p2 <- ggplot(data = g46_bias_all, aes(x=bias, y= Log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0.85)) +
  coord_cartesian(ylim = c(-6,0,2,5,12))  +
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/g46_fbias_rpkmfdr.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/g46_mbias_rpkmfdr.txt", sep="\t", col.names=T)

g46_fbias_rpkmfrd_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/g46_fbias_all_cutoff_rpkm_fifi.txt", header = T)
str(g46_fbias_rpkmfrd_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/cutoff_rpkm_g46_fbias.pdf")

A2 <- ggplot(data = g46_fbias_rpkmfrd_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
...
g46_mbias_rpkmfrd_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/g46_mbias_all_rpkmfdr_cutoff_fi.txt", header = T)
str(g46_mbias_rpkmfrd_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/cutoff_rpkm_g46_mbias.pdf")

B2 <- ggplot(data = g46_mbias_rpkmfrd_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-13,-10,-5,0,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/cutoff_rpkm_g46_fi.pdf")
...
kdata <- read.table("~/Rana_Transcriptome/output/Amgonad/gonad_rpkm_FDR05_newcutoff_sorted.txt", header=TRUE)
str(kdata)
...
#write.table(kdata1, "~/Rana_Transcriptome/input/CPM/gonad_fbias_cutoff_rpkm.txt", sep="\t", col.names=T)
#write.table(kdata2, "~/Rana_Transcriptome/input/CPM/gonad_mbias_cutoff_rpkm.txt", sep="\t", col.names=T)

write.table(kdata1, "~/Rana_Transcriptome/input/CPM/gonad_fbias_cutoff_rpkm_rmslimit.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/gonad_mbias_cutoff_rpkm_rmslimit.txt", sep="\t", col.names=T)

###the version including sex-limited genes
gonad_mbias_rpkm_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/gonad_mbias_cutoff_all_newfi.txt", header = TRUE)
str(gonad_mbias_rpkm_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/mbias_rpkm_gonad_cutoff.pdf")

 <- ggplot(data = gonad_mbias_rpkm_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
...
gonad_fbias_rpkm_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/gonad_fbias_rpkm_cutoff_newfi.txt", header = TRUE)
str(gonad_fbias_rpkm_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/fbias_rpkm_gonad_cutoff_newfi.pdf")

 <- ggplot(data = gonad_fbias_rpkm_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15,-10,-5,0,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/cutoff_rpkm_gonad.pdf")
...
gonad_mbias_rpkm_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/gonad_mbias_cutoff_rpkm_rmslimit_fi.txt", header = TRUE)
str(gonad_mbias_rpkm_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/mbias_rpkm_gonad_cutoff_rmsexlimit.pdf")
...
gonad_fbias_rpkm_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/gonad_fbias_cutoff_rpkm_rmslimit_fi.txt", header = TRUE)
str(gonad_fbias_rpkm_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/fbias_rpkm_gonad_cutoff_newfi_rmsexlimit.pdf")
...
pdf(file="~/Rana_Transcriptome/output/figures/cutoff_rpkm_gonad_rmsexlimit.pdf")
...
kdata_unb <- read.table("~/Rana_Transcriptome/input/CPM/rpkm_amm_gonad.txt", header = TRUE)
str(kdata_unb)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/gonad_fbias_fdr.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/gonad_mbias_fdr.txt", sep="\t", col.names=T)
write.table(kdata3, "~/Rana_Transcriptome/input/CPM/gonad_unbias_fdr.txt", sep="\t", col.names=T)

gonad_f <- read.table("~/Rana_Transcriptome/input/CPM/gonad_fbias_fdr_input2.txt", header = T)
gonad_f$bias="female"
gonad_m <- read.table("~/Rana_Transcriptome/input/CPM/gonad_mbias_fdr_input2.txt", header = F)
gonad_m$bias="male"
gonad_un <- read.table("~/Rana_Transcriptome/input/CPM/gonad_unbias_fdr_input2.txt", header = F)
gonad_un$bias="unbias"

write.table(gonad_f, "~/Rana_Transcriptome/input/CPM/gonad_fbias_fdr_input3.txt", sep="\t", col.names=T)
write.table(gonad_m, "~/Rana_Transcriptome/input/CPM/gonad_mbias_fdr_input3.txt", sep="\t", col.names=T)
write.table(gonad_un, "~/Rana_Transcriptome/input/CPM/gonad_unbias_fdr_input3.txt", sep="\t", col.names=T)

gonad_rpkm_fdr <- read.table("~/Rana_Transcriptome/input/CPM/gonad_sbunbias_fdr_newfifi.txt", header = T)
str(gonad_rpkm_fdr)

pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_log2rpkm_gonad.pdf")

p3 <-ggplot(data = gonad_rpkm_fdr, aes(x=bias, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0.85)) +
  coord_cartesian(ylim = c(-6, 0, 5, 12)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
  theme(legend.justification=c(1,0), legend.position=c(1,0))
#theme(legend.position="none")
...
kdata <- read.table("~/Rana_Transcriptome/output/Amliver/rpkm_amliver_sorted_fi.txt", header=TRUE)
str(kdata)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/liver_fbias.txt", sep="\t", col.names=F)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/liver_mbias.txt", sep="\t", col.names=F)
write.table(kdata3, "~/Rana_Transcriptome/input/CPM/liver_unbias.txt", sep="\t", col.names=F)

liver_fbias_all <- read.table("~/Rana_Transcriptome/input/CPM/liver_fbias1.txt", header=TRUE)
liver_fbias_all$bias = "female"
liver_mbias_all <- read.table("~/Rana_Transcriptome/input/CPM/liver_mbias1.txt", header=TRUE)
liver_mbias_all$bias = "male"
liver_unbias_all <- read.table("~/Rana_Transcriptome/input/CPM/liver_unbias1.txt", header=TRUE)
liver_unbias_all$bias = "unbias"

write.table(liver_fbias_all, "~/Rana_Transcriptome/input/CPM/liver_fbias_all.txt", sep="\t", col.names=F)
write.table(liver_mbias_all, "~/Rana_Transcriptome/input/CPM/liver_mbias_all.txt", sep="\t", col.names=F)
write.table(liver_unbias_all, "~/Rana_Transcriptome/input/CPM/liver_unbias_all.txt", sep="\t", col.names=F)

liver_sbunbias_rpkm <- read.table("~/Rana_Transcriptome/input/CPM/liver_sbunbias_all_fi.txt", header = TRUE)

pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_logrpkm_liver.pdf")
...
####
brain_fbias_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$Bias=='female')
brain_mbias_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$Bias=='male')
brain_unbias_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$Bias=='unbias')

wilcox.test(brain_fbias_rpkm$log2RPKM[brain_fbias_rpkm$Sex=='meanmale'], brain_fbias_rpkm$log2RPKM[brain_fbias_rpkm$Sex=='meanfemale'])#W = 282800, p-value < 2.2e-16
wilcox.test(brain_mbias_rpkm$log2RPKM[brain_mbias_rpkm$Sex=='meanmale'], brain_mbias_rpkm$log2RPKM[brain_mbias_rpkm$Sex=='meanfemale']) #W = 285950, p-value < 2.2e-16
wilcox.test(brain_unbias_rpkm$log2RPKM[brain_unbias_rpkm$Sex=='meanmale'],brain_unbias_rpkm$log2RPKM[brain_unbias_rpkm$Sex=='meanfemale']) #W = 141100000, p-value = 0.319

liver_female_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$Sex=='meanfemale')
...
liver_male_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$Sex=='meanmale')
...
kdata <- read.table("~/Rana_Transcriptome/output/Amliver/rpkm_amliver_sorted_cutoff_fi.txt", header=TRUE)
str(kdata)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/liver_fbias2_cutoff2.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/liver_mbias2_cutoff2.txt", sep="\t", col.names=T)

liver_mbias_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/liver_mbias2_cutoff_inclusexlimit_fi.txt", header=TRUE)
str(liver_mbias_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_liver_mbias.pdf")

B4 <-  ggplot(data =liver_mbias_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-18,-10, -5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
  theme(legend.justification=c(1,0), legend.position=c(1,0))
...
liver_fbias_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/liver_sb_cutoff_inclusexlimit_fi.txt", header=TRUE)
str(liver_fbias_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_liver_fbias.pdf")

A4 <- ggplot(data =liver_fbias_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-18,-10, -5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_liver_inclusexlimit.pdf")
...
###load G43 datasets
kdata <- read.table("~/Rana_Transcriptome/output/Amg43/rpkm_ammg43_fi.txt", header=TRUE)
str(kdata)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/g43_fbias.txt", sep="\t", col.names=F)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/g43_mbias.txt", sep="\t", col.names=F)
write.table(kdata3, "~/Rana_Transcriptome/input/CPM/g43_unbias.txt", sep="\t", col.names=F)

g43_fbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g43_fbias1.txt", header=TRUE)
g43_fbias_all$bias = "female"
g43_mbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g43_mbias1.txt", header=TRUE)
g43_mbias_all$bias = "male"
g43_unbias_all <- read.table("~/Rana_Transcriptome/input/CPM/g43_unbias1.txt", header=TRUE)
g43_unbias_all$bias = "unbias"

write.table(g43_fbias_all, "~/Rana_Transcriptome/input/CPM/g43_fbias_all.txt", sep="\t", col.names=F)
write.table(g43_mbias_all, "~/Rana_Transcriptome/input/CPM/g43_mbias_all.txt", sep="\t", col.names=F)
write.table(g43_unbias_all, "~/Rana_Transcriptome/input/CPM/g43_unbias_all.txt", sep="\t", col.names=F)

g43_sbunbias_rpkm <- read.table("~/Rana_Transcriptome/input/CPM/g43_sbunbias_rpkm_fi.txt", header = TRUE)
str(g43_sbunbias_rpkm)

pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_logrpkm_g43.pdf")
...
pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_logrpkm_g43G46gonadliverbrain.pdf")
...
kdata <- read.table("~/Rana_Transcriptome/output/Amg43/rpkm_ammg43_forcutoff.txt", header=TRUE)
str(kdata)
...
write.table(kdata1, "~/Rana_Transcriptome/input/CPM/g43_fbias2_cutoff.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/g43_mbias2_cutoff.txt", sep="\t", col.names=T)

g43_fbias_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/g43_fbias2_cutoff_inclsexlimit_fi.txt", header=TRUE)
str(g43_fbias_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_g43_fbias.pdf")

A1 <- ggplot(data = g43_fbias_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
...
g43_mbias_cutoff <- read.table("~/Rana_Transcriptome/input/CPM/g43_mbias_cutoff_inclusexlimit_fi.txt", header=TRUE)
str(g43_mbias_cutoff)

pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_g43_mbias.pdf")

B1 <- ggplot(data = g43_mbias_cutoff, aes(x=cutoff, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15,-10, -5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_adtissues_AB.pdf")

ggarrange(A5,B5,A3,B3,A4,B4, labels = c("A3","B3","A4","B4","A5","B5"),
          ncol = 2, nrow = 3)

dev.off()


pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_g43G46_AB.pdf")

ggarrange(A1,B1,A2,B2, labels = c("A1","B1","A2","B2"),
          ncol = 2, nrow = 2)
...
##put four figures in one page
pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_g43_inclusexlimit.pdf")
...
gonad_fbias_annotation <- read.table("~/Rana_Transcriptome/input/CPM/gonad_sb/gonad_fbias_rpkm_cutoff_newfi.txt", header=TRUE)
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_fbias_chr01_cutoff.pdf")
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_fbias_chr02_cutoff.pdf")
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_fbias_auto_cutoff.pdf")

A3 <- ggplot(data = gonad_fbias_annotation, aes(x=cutoff, y= log2RPKM, fill =sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15, -10,-5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
gonad_mbias_annotation <- read.table("~/Rana_Transcriptome/input/CPM/gonad_sb/gonad_mbias_cutoff_all_newfi.txt", header=TRUE)
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_mbias_chr01_cutoff.pdf")

B3 <- ggplot(data = gonad_mbias_chr01_annot, aes(x=cutoff, y= log2RPKM, fill =sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15, -10,-5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_mbias_chr02_cutoff.pdf")
...
pdf(file="~/Rana_Transcriptome/output/figures/gonad_mbias_auto_cutoff.pdf")

 B3 <- ggplot(data = gonad_mbias_annotation, aes(x=cutoff, y= log2RPKM, fill =sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15,-10, -5, 0,2,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
###Brain 
###unbias and sex bias
kdata <- read.table("~/Rana_Transcriptome/output/Ambrain/brain_cpm05_rpmk.txt", header=TRUE)
str(kdata)

kdata1 <- subset(kdata, kdata$logFC.XYbrain.XXbrain<=-1 & kdata$FDR.XYbrain.XXbrain< 0.05)
kdata2 <- subset(kdata, kdata$logFC.XYbrain.XXbrain>=1 & kdata$FDR.XYbrain.XXbrain< 0.05)
kdata3 <- subset(kdata, kdata$logFC.XYbrain.XXbrain> -1 & kdata$logFC.XYbrain.XXbrain< 1)

kdata1$meanXY <- log2((kdata1$A10MB + kdata1$A15MB + kdata1$A16MB + kdata1$A17MB + kdata1$A8MB)/5 + 0.0001)
kdata1$group1 = "meanmale"
kdata1$meanXX <- log2((kdata1$A10FB + kdata1$A12FB + kdata1$A15FB + kdata1$A16FB + kdata1$A17FB) /5 + 0.0001)
kdata1$group2="meanfemale"

kdata2$meanXY <- log2((kdata2$A10MB + kdata2$A15MB + kdata2$A16MB + kdata2$A17MB + kdata2$A8MB) /5 + 0.0001)
kdata2$group1="meanmale"
kdata2$meanXX <- log2((kdata2$A10FB + kdata2$A12FB + kdata2$A15FB + kdata2$A16FB + kdata2$A17FB) /5 + 0.0001)
kdata2$group2="meanfemale"

kdata3$meanXY <- log2((kdata3$A10MB + kdata3$A15MB + kdata3$A16MB + kdata3$A17MB + kdata3$A8MB) /5 + 0.0001)
kdata3$group1="meanmale"
kdata3$meanXX <- log2((kdata3$A10FB + kdata3$A12FB + kdata3$A15FB + kdata3$A16FB + kdata3$A17FB) /5 + 0.0001)
kdata3$group2="meanfemale"

write.table(kdata1, "~/Rana_Transcriptome/input/CPM/brain_fbias_fdr.txt", sep="\t", col.names=T)
write.table(kdata2, "~/Rana_Transcriptome/input/CPM/brain_mbias_fdr.txt", sep="\t", col.names=T)
write.table(kdata3, "~/Rana_Transcriptome/input/CPM/brain_unbias_fdr.txt", sep="\t", col.names=T)

brain_sbunbias_rpkm <- read.table("~/Rana_Transcriptome/input/CPM/brain_sbunbias_rpkm_fi.txt", header = TRUE)
str(brain_sbunbias_rpkm)

pdf(file="~/Rana_Transcriptome/output/figures/sbunbias_logrpkm_brain.pdf")

p5 <- ggplot(data = brain_sbunbias_rpkm, aes(x=bias, y= log2RPKM, fill=sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0.85)) +
  coord_cartesian(ylim = c(-6,0,2,5,12))  +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
wilcox.test(brain_fbias_rpkm$log2RPKM[brain_fbias_rpkm$sex=='meanmale'], brain_fbias_rpkm$log2RPKM[brain_fbias_rpkm$sex=='meanfemale'])#W = 526, p-value < 2.2e-16
wilcox.test(brain_mbias_rpkm$log2RPKM[brain_mbias_rpkm$sex=='meanmale'], brain_mbias_rpkm$log2RPKM[brain_mbias_rpkm$sex=='meanfemale']) #W = 4441, p-value = 9.401e-10
wilcox.test(brain_unbias_rpkm$log2RPKM[brain_unbias_rpkm$sex=='meanmale'],brain_unbias_rpkm$log2RPKM[brain_unbias_rpkm$sex=='meanfemale']) #W = 334720000, p-value = 0.414

brain_female_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$sex=='meanfemale')
wilcox.test(brain_female_rpkm$log2RPKM[brain_female_rpkm$bias=='male'], brain_female_rpkm$log2RPKM[brain_female_rpkm$bias=='unbias'])#W = 421420, p-value < 2.2e-16
wilcox.test(brain_female_rpkm$log2RPKM[brain_female_rpkm$bias=='female'], brain_female_rpkm$log2RPKM[brain_female_rpkm$bias=='unbias'])#W = 801920, p-value = 0.02758

brain_male_rpkm <- subset(brain_sbunbias_rpkm, brain_sbunbias_rpkm$sex=='meanmale')
wilcox.test(brain_male_rpkm$log2RPKM[brain_male_rpkm$bias=='male'], brain_male_rpkm$log2RPKM[brain_male_rpkm$bias=='unbias'])#W = 964360, p-value = 0.952
wilcox.test(brain_male_rpkm$log2RPKM[brain_male_rpkm$bias=='female'], brain_male_rpkm$log2RPKM[brain_male_rpkm$bias=='unbias'])#W = 159020, p-value < 2.2e-16


####brain cutoff sex bias
brain_fcutoff_rpkm <- read.table("~/Rana_Transcriptome/input/CPM/brain_fbias_cutoff_rpkm_fi.txt", header = TRUE)
str(brain_fcutoff_rpkm)

pdf(file="~/Rana_Transcriptome/output/figures/fbiascutoff_logrpkm_brain.pdf")

A5 <- ggplot(data = brain_fcutoff_rpkm, aes(x=cutoff, y= log2RPKM, fill =sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15,-10,-5, 0,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
brain_mcutoff_rpkm <- read.table("~/Rana_Transcriptome/input/CPM/brain_mbias_cutoff_rpkm_fi.txt", header = TRUE)
str(brain_mcutoff_rpkm)

pdf(file="~/Rana_Transcriptome/output/figures/mbiascutoff_logrpkm_brain.pdf")

B5 <- ggplot(data = brain_mcutoff_rpkm, aes(x=cutoff, y= log2RPKM, fill =sex)) + 
  geom_boxplot(notch=TRUE,outlier.shape=NA,position=position_dodge(0), width=0.9,alpha=0.9) +
  coord_cartesian(ylim = c(-15,-10,-5, 0,5,10)) +
  scale_fill_manual(values = c("red3","dodgerblue3")) +
  theme_set(theme_bw(base_size=12)) +
...
pdf(file="~/Rana_Transcriptome/output/figures/sbcutoff_logrpkm_brain_inclusexlimit.pdf")

ggarrange(p_fbrain,p_mbrain, labels = c("A", "B"),
          ncol = 2, nrow = 1)

dev.off()

##stats
mbias_male_brain <- subset (brain_mcutoff_rpkm, brain_mcutoff_rpkm$sex=='meanmale')
wilcox.test(mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC1'], mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC3'])# W = 503, p-value = 0.431
wilcox.test(mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC3'], mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC5'])# W = 34, p-value = 0.7846
wilcox.test(mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC5'], mbias_male_brain$log2RPKM[mbias_male_brain$cutoff=='FC7'])# W = 11, p-value = 0.9048

mbias_female_brain <- subset (brain_mcutoff_rpkm, brain_mcutoff_rpkm$sex=='meanfemale')
wilcox.test(mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC1'], mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC3'])# W = 719, p-value = 5.938e-05
wilcox.test(mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC3'], mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC5'])#W = 18, p-value = 0.05501
wilcox.test(mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC5'], mbias_female_brain$log2RPKM[mbias_female_brain$cutoff=='FC7'])# Na

fbias_male_brain <- subset (brain_fcutoff_rpkm, brain_fcutoff_rpkm$sex=='meanmale')
wilcox.test(fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC1'], fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC3'])#W = 502, p-value = 1.689e-07
wilcox.test(fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC3'], fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC5'])# W = 444, p-value = 0.001374
wilcox.test(fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC5'], fbias_male_brain$log2RPKM[fbias_male_brain$cutoff=='FC7'])# Na

fbias_female_brain <- subset (brain_fcutoff_rpkm, brain_fcutoff_rpkm$sex=='meanfemale')
wilcox.test(fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC1'], fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC3'])#W = 331, p-value = 0.2489
wilcox.test(fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC3'], fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC5'])# W = 298, p-value = 0.8799
wilcox.test(fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC5'], fbias_female_brain$log2RPKM[fbias_female_brain$cutoff=='FC7'])# W = 36, p-value = 0.3706
