...
#results directoy
setwd("/Users/Wen-Juan/my_postdoc/useful_scripts/Sex_reversal_gene_expression/output/")

dn_ds<-read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/Rtemp_list_keep.txt", header=T)
dnds46unbias<-read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/dn_ds_unbias46_ds2.1.txt")
hist(dn_ds$dNdS, breaks = 1000, col = "grey", border = "black", ylim = c(0, 300),xlim=c(0,0.6), main = "dn/ds overall distribution",xlab = "dn/ds",ylab = "frequency")
hist(dnds46unbias$V3, breaks = 1000, col = "grey", border = "black", ylim = c(0, 800),xlim=c(0,0.6), main = "dn/ds overall distribution",xlab = "dn/ds",ylab = "frequency")

dn_ds_all<-read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/dn_ds_all_stages.txt", header = T)
str(dn_ds_all)
dn_ds_4346 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/dn_ds_G4346.txt", header = T)
dn_ds_4346_allcat2 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/dn_ds_4346_allcat2.txt", header = T)
str(dn_ds_4346_allcat2)
share_dnds_4346 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/share_sb_unbias_4346.txt", header = T)
str(share_dnds_4346)
share_dnds_abs4346 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/share_sb_unbias_abs4346.txt", header = T)
str(share_dnds_abs4346)

dnds_46_log2 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/de_0.05_2_tv46_dnds.txt", header = T)
str(dnds_46_log2)
dnds_46_log3 <- read.table("/Users/Wen-Juan/git/rana_transcriptome/input/dnds/de_0.05_3_tv46_dnds.txt", header = T)
str(dnds_46_log3)
dn_ds_auto <-read.table("/Users/Wen-Juan/my_postdoc/useful_scripts/Sex_reversal_gene_expression/input/dn_ds_auto.txt", header = T)
str(dn_ds_auto)
hist(dn_ds_auto$dNdS, breaks = 200, col = "grey", border = "black", ylim = c(0, 800),xlim=c(0,0.6), main = "dn/ds overall distribution",xlab = "dn/ds",ylab = "frequency")
dn_ds_sexchr <-read.table("/Users/Wen-Juan/my_postdoc/useful_scripts/Sex_reversal_gene_expression/input/dn_ds_sexchr.txt", header = T)
str(dn_ds_sexchr)
hist(dn_ds_sexchr$dN.dS, breaks = 50, col = "grey", border = "black", ylim = c(0, 800),xlim=c(0,0.6), main = "dn/ds overall distribution",xlab = "dn/ds",ylab = "frequency")
dn_ds <-read.table("/Users/Wen-Juan/my_postdoc/useful_scripts/Sex_reversal_gene_expression/input/dn_ds.txt", header = T)

hist(dn_ds$dNdS, breaks = 300, col = "grey", border = "black", ylim = c(0, 800),xlim=c(0,0.6), main = "dn/ds overall distribution",xlab = "dn/ds",ylab = "frequency")
...
dn_ds_auto_ID <- as.factor(dn_ds_auto$ID)
dn_ds_sexchr_ID <- as.factor(dn_ds_sexchr$ID)
str(dn_ds_all)
