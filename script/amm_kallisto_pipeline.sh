...
adults:
3 tissues, 29 libraries (almost 5 replicates per tissue per sex)

# index the transcriptome
module add UHTS/Analysis/kallisto/0.43.0
kallisto index -i am_transcripts.idx /scratch/beegfs/monthly/wjma/amm_rna/expression/Amm_transcripts.fasta

#quantify counts for each transcripts using Kallisto
module add UHTS/Analysis/kallisto/0.43.0
