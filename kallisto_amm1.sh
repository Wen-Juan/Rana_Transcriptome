...
do
kallisto quant -i /scratch/beegfs/monthly/wjma/rtRNAseq/all/ref_tseries/rt_amm_devonly.idx -o ./${f%%_pairedR1.fastq} -b 100 ${f%%_pairedR1.fastq}_pairedR1.fastq ${f%%_pairedR1.fastq}_pairedR2.fastq
done
